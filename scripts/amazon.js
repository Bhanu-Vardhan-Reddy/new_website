...
document.querySelectorAll('.add-to-cart-button').forEach((button) => {
  button.addEventListener('click', () => {
    ...
    const quantity = parseInt(document.getElementById(`product-quantity-${productId}`).value); // Get selected quantity

    // Check if the product is already in the cart
    let match = cart.find((item) => item.id === productId);
